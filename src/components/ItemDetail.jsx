  ...
  <div className="container">
    <div className="row d-flex justify-content-center align-items-center">
      <div className="col-md-6">
        <img src={selectProd.image} alt={selectProd.nombre} style={{maxWidth: '70%'}}/>
      </div>
      <div className="col-md-6 ml-3">
        <div className="card border-light">
          <div className="card-body">
            ...
            <CartCount quantity={quantity} incrementQuantity={incrementQuantity} decrementQuantity={decrementQuantity}/>
            <button onClick={handleAgregarAlCarrito} className="btnCarrito">{isInCart ? "Eliminar del carrito" : "Agregar al carrito"}</button>
          </div>
        </div>
      </div>
    </div>
